 ...
 */
let nameInCaps="SHUBHAM"
let nameInLower="shubham"
 ...
 */
if nameInCaps.lowercased() == nameInLower
{
    print("\(nameInLower) and \(nameInCaps) are the same.")
}
else
{
    print("\(nameInLower) and \(nameInCaps) are not the same.")
}
...
print("Characters In Name:", nameInCaps.count)
