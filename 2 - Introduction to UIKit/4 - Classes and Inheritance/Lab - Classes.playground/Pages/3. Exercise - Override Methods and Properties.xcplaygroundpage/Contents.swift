...
defender.moveRight()
print("Defender Position:",defender.position)
defender.fire()
print("Defender Remaining power:",defender.remainingFirePower)
...
defender.wasHit()
print("Defender shieldStrength:",defender.shieldStrength)
