    ...
    func disp()
    {
        if(activityLevel<1 || activityLevel>10)
        {
            print("Name of the user is:", name,
                  ...
                  "Height of the user is:", height,
                  "Weight of the user is:", weight,"Enter activity level bw 1-10");
        }
        else
        {
            print("Name of the user is:", name,
                  "Age of the user is:", age,
                  "Height of the user is:", height,
                  "Weight of the user is:", weight,
                  "Activity Level of the user is:", activityLevel)
        }
    }
}

//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var ok=User(name: "Shubham", age: 20, height: 187.5, weight: 100, activityLevel: 0)
ok.disp()
/*:
...
struct Distance
{
    ...
    init(inFeet:Double)
    {
        self.inMeters = inFeet / 3.28084
    }
    func disp()
    {
        print("The distance in meters:",inMeters,"Distance in Feet:",inFeet)
    }
}
var d=Distance(inFeet:5249.344)
d.disp()
...
var distance=Distance(inMeters: 1000)
distance.disp()
