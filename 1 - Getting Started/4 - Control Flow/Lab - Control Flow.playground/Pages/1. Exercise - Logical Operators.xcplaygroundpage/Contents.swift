 ...
 */
print("Value:false")
print("Expected:",1.9==9)
//:  2. `9 != 9`
print("Value:true")
print("Expected:", (2.9 != 9))

//:  3. `47 > 90`
print("Value:false")
print("Expected:",(3.47>90))
//:  4. `47 < 90`
print("Value:true")
print("Expected:",(4.47<90))
//:  5. `4 <= 4`
print("Value:false")
print("Expected:",(5.4<=4))

//:  6. `4 >= 5`
print("Value:true")
print("Expected:",6.4>=5)

//:  7. `(47 > 90) && (47 < 90)`
print("Value:false")
print("Expected:",(47 > 90) && (47 < 90))
