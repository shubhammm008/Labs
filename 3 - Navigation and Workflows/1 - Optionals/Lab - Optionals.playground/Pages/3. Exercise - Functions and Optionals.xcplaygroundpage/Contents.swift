...
func checkAge(age:String) -> Int?
{
    ...
    if let age=ageInt{
        print("Age After Conversion To Int:",age)
        if(age>18)
        {
            print("Welcome")
        }
...
var check:Int? = checkAge(age: "34e")
if let p=check{
    print("Age:",p)
}
else
...
func checkin(item:String) -> Double?
{
...
var ok:Double?=checkin(item: "Juice")
if let m=ok{
    print("Price Of Quantity:",m)
}
else
{
    print(ok)
